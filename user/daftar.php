...
<head>
    ...
    <title>UNIVERRSITAS MAYASARI BAKTI: Pendaftaran</title>
                            ...
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
										 Selamat datang di sistem informasi Penerimaan Mahasiswa Baru (PMB) Online.
                                         <br><br>
                                         Panduan Pendaftaran:
                                         ...
                                         <br>
                                         <br>*Note: Pihak kampus akan menerima data Anda setelah Anda klik 'Confirm'
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!------------------ Pisahin ------------------->
        ...
        <footer>
            <div class="footer-area">
                <p>PMB Online by Nur Alpriyanti</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
